...
// Include functions
require_once LOOPIS_ADMIN_DIR . 'functions/hq/admin-menu-posts.php';
require_once LOOPIS_ADMIN_DIR . 'functions/hq/admin-menu-cpt.php';
require_once LOOPIS_ADMIN_DIR . 'functions/hq/admin-menu-reorder.php';
